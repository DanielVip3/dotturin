...
state_schema = "last_game string, last_title string, last_viewers long, last_ts timestamp"
...
transitions_df = (
  bronze_df.select("stream_id", "user_name", "game_name", "title", "viewer_count", "ingestion_ts")
  .groupBy("stream_id")
...
query = (
  transitions_df.writeStream.format("delta")
  .outputMode("append")
